...
#include "ping_pong_png.h"
#include "bounce_mp3.h"
...
int main(){
    ...
    Wave wave = LoadWaveFromMemory(".mp3", bounce_mp3, bounce_mp3_len);
    Sound bounceSound = LoadSoundFromWave(wave);
    UnloadWave(wave); 
    
    SetTargetFPS(60);

    Image windowIcon = LoadImageFromMemory(".png", ping_pong_png, ping_pong_png_len);
